...
;
const metadata = {
    title: "Ahashan Ali - Android Developer",
    description: "Junior Software Engineer specializing in Android development with Kotlin/Java, MVVM architecture, and modern Android tools",
    generator: "v0.app",
    icons: {
        icon: [
            {
